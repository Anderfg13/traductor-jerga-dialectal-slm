...
La Fase 1 dejó la arquitectura como una visión de cuatro etapas sin desarrollar (Figura \ref{fig:pipeline}). Esta sección describe qué tanto de esa visión ya es real a la fecha de esta entrega, separada en tres frentes —datos, aplicación y tecnología—, más la gobernanza del proyecto y la hoja de ruta hacia el cierre de esta fase. Un punto se repite en los tres frentes: por decisión de alcance tomada desde el principio, \textbf{esta fase cubre un solo generador sintético (de los tres considerados) y deja la fusión de modelos para la fase final} —no por falta de tiempo, sino para poder construir y probar el \textit{pipeline} completo de punta a punta con una sola fuente de datos antes de triplicar el trabajo.
